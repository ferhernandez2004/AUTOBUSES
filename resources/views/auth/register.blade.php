@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('BUSES I.O')])
          ...
          <div class="card-body ">
            ...
            {{-- <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                ...
                {{ __('De acuerdo con la ') }} <a href="#">{{ __('Politica de Privacidad') }}</a>
              </label>
            </div> --}}
          </div>
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-danger btn-link btn-lg">{{ __('Crear cuenta') }}</button>
          </div>
        </div>
      </form>
    </div>
